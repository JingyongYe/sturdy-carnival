...
public class CodeMsg {
	...
	//自习室类型管理类错误码
	public static CodeMsg ADMIN_READ_ISEXIST= new CodeMsg(-13001, "自习室类型已经存在！");
	public static CodeMsg ADMIN_READ_DELETE = new CodeMsg(-13002, "自习室类型存在关联数据删除失败！请联系管理员");
    //自习室
	public static CodeMsg ADMIN_READING_DELETE = new CodeMsg(-13003, "自习室存在关联数据删除失败！请联系管理员");
	public static CodeMsg ADMIN_READING_ISEXIST= new CodeMsg(-13004, "自习室已经存在！");
