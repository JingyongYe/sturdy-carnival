                ...
                <form class="pull-right search-bar" method="get" action="list" student="form">
                  <div class="input-group">
                    <div class="input-group-btn">
                      ...
                      管理员名称 <span class="caret"></span>
                      </button>
                      <ul class="dropdown-menu">
                        <li> <a tabindex="-1" href="javascript:void(0)" data-field="title">管理员名称</a> </li>
                      </ul>
                    </div>
                    <input type="text" class="form-control" value="${name!""}" name="user.nickName" placeholder="请输入管理员名称">
